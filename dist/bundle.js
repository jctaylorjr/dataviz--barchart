...
(function () {
	...
	*/
	...
	const centerY = height / 2; // const ColorArc = ({ mouthRadius, mouthWidth }) => {
	// 	const colorArc = arc()
	...
	const colorArc = arc().innerRadius(100).outerRadius(200);
	...
	const App = () => {
	  ...
	  }, colorPie(data).map(d => /*#__PURE__*/React.createElement("path", {
